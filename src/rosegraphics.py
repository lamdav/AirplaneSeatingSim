...
class Point(_Shape, _ShapeWithOutline):
    ...
    def move_by(self, delta_x, delta_y):
        msg = 'This  move_by   method has been disabled for Test 1 Practice.\n'
        msg += 'It can lead to subtle errors on one of the problems.\n'
        msg += 'You can solve all the Test 1 Practice problems\n'
        msg += 'WITHOUT using move_by or move_to.\n'
        raise Exception(msg)
#         self.x = self.x + delta_x
#         self.y = self.y + delta_y

    def move_to(self, x, y):
        msg = 'This  move_to   method has been disabled for Test 1 Practice.\n'
        msg += 'It can lead to subtle errors on one of the problems.\n'
        msg += 'You can solve all the Test 1 Practice problems\n'
        msg += 'WITHOUT using move_by or move_to.\n'
        raise Exception(msg)
